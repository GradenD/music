...
!function(a, b) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        option: function(a, c) {
            ...
            switch (this.options.playlistOptions[a] = c,
            a) {
        ...
        _refresh: function(b) {
            ...
            if (b && !a.isFunction(b))
                ...
                a(this.cssSelector.playlist + " ul").slideUp(d, function() {
                    ...
                    c._updateControls(),
                    a.isFunction(b) && b(),
                    c.playlist.length ? a(this).slideDown(c.options.playlistOptions.displayTime) : a(this).show()
                })
            }
        },
        _createListItem: function(b) {
            var c = this
              , d = "<li><div>";
            if (d += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>",
            b.free) {
                var e = !0;
                d += "<span class='" + this.options.playlistOptions.freeGroupClass + "'>(",
                a.each(b, function(b, f) {
                    a.jPlayer.prototype.format[b] && (e ? e = !1 : d += " | ",
                    d += "<a class='" + c.options.playlistOptions.freeItemClass + "' href='" + f + "' tabindex='-1'>" + b + "</a>")
                }),
                d += ")</span>"
            }
            return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + b.title + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</a>",
            d += "</div><div class='repeat'><i class='fas fa-redo'></i></div><div data-config='" + b.id + "' class='select'></i><i class='sound-select fas fa-times'></i></div><div class='"+ this.options.playlistOptions.loader +"'><div class='"+ this.options.playlistOptions.iems1 +"'></div><div class='"+ this.options.playlistOptions.iems2 +"'></div><div class='"+ this.options.playlistOptions.iems3 +"'></div><div class='"+ this.options.playlistOptions.iems4 +"'></div><div class='"+ this.options.playlistOptions.iems5 +"'></div></div></li>"
        },
        ...
        _updateControls: function() {
            ...
            this.shuffled ? a(this.cssSelector.jPlayer).jPlayer("addStateClass", "shuffled") : a(this.cssSelector.jPlayer).jPlayer("removeStateClass", "shuffled"),
            a(this.cssSelector.shuffle).length && a(this.cssSelector.shuffleOff).length && (this.shuffled ? (a(this.cssSelector.shuffleOff).show(),
            a(this.cssSelector.shuffle).hide()) : (a(this.cssSelector.shuffleOff).hide(),
        ...
        remove: function(c) {
            ...
            !0) : this.removing ? !1 : (c = 0 > c ? d.original.length + c : c,
            c >= 0 && c < this.playlist.length && (this.removing = !0,
            a(this.cssSelector.playlist + " li:nth-child(" + (c + 1) + ")").slideUp(this.options.playlistOptions.removeTime, function() {
                if (a(this).remove(),
                d.shuffled) {
                    var b = d.playlist[c];
                    a.each(d.original, function(a) {
                        return d.original[a] === b ? (d.original.splice(a, 1),
                        !1) : void 0
                    }),
                    ...
                    d.playlist.splice(c, 1);
                d.original.length ? c === d.current ? (d.current = c < d.original.length ? d.current : d.original.length - 1,
                d.select(d.current)) : c < d.current && d.current-- : (a(d.cssSelector.jPlayer).jPlayer("clearMedia"),
                d.current = 0,
                d.shuffled = !1,
                d._updateControls()),
                d.removing = !1
        ...
        select: function(b) {
            ...
            b >= 0 && b < this.playlist.length ? (this.current = b,
            this._highlight(b),
        ...
        next: function() {
            /* условие на повтор */
            if ($('#music-list').find('.repeat-active').length > 0) {
                var a = this.current + 1 < this.playlist.length ? this.current : 0;
            }else{
        ...
        shuffle: function(c, d) {
            var e = this;
            c === b && (c = !this.shuffled),
            (c || c !== this.shuffled) && a(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, function() {
                e.shuffled = c,
                c ? e.playlist.sort(function() {
                    return .5 - Math.random()
                }) : e._originalPlaylist(),
                e._refresh(!0),
                d || !a(e.cssSelector.jPlayer).data("jPlayer").status.paused ? e.play(0) : e.select(0),
